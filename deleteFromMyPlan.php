...
<?php
    ...
    $sql = "DELETE FROM myplan WHERE title=\"" . $title . "\" and year=\"" . $year . "\"";
    echo $sql;
    $result = $db->query($sql);
    
    if(!$result) {
        header("Location: https://personal-movies-management-deepd.c9.io/home.php?action=" . "deletemovie&" ."title=" . $title . "&failed=true");
    }
    else {
        header("Location: https://personal-movies-management-deepd.c9.io/home.php?action=" . "deletemovie&" ."title=" . $title);
    }
