...
<?php
    ...
    if($action == "addmovie") {
        if($failed != "true") {
            echo $title . " - Added to the list of movies\n";
        }
        else {
            echo $title . " - Not added to the list of movies\n";
        }
    }
    if($action == "deletemovie") {
        if($failed != "true") {
            echo $title . " - Deleted from the list of movies\n";
        }
        else {
            echo $title . " - Not deleted from the list of movies because it is in My Plan\n";
        }
    }
    if($action == "updatemovie") {
        if($failed != "true") {
            echo $title . " - Updated in the list of movies\n";
        }
        else {
            echo $title . " - Not updated in the list of movies\n";
        }
    }
