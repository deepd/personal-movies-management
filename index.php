...
<body>
    ...
    <div class="container">
      <div class="jumbotron">
        <h1 align="center">My Movies Plan</h1> 
      </div>
    </div>
<?php
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<div><td>" . $row['Title'] . "<a href=\"https://personal-movies-management-deepd.c9.io/deleteFromMyPlan.php?title=" . $row['Title'] . 
            "&year=" . $row['Year'] . "\" class=\"btn btn-danger btn-xs\" style=\"float: right;\">Remove</a>" . "</td></div>";
