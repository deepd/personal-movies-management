...
<?php
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<div><td>" . $row['Title'] . "<a href=\"https://personal-movies-management-deepd.c9.io/deleteFromList.php?title=" . $row['Title'] . 
            "&year=" . $row['Year'] . "\" class=\"btn btn-danger btn-xs\" style=\"float: right;\">Delete</a>" . "</td></div>";
